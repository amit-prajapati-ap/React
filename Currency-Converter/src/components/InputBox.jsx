    ...
    <div>
      <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
        ...
        <div className='w-1/2'>
          ...
          <input id={amountInputId} type="number" placeholder='Amount' className='outline-none w-full bg-transparent py-1.5' disabled={amountDisable} value={amount} onChange={(e) => onAmountChange && onAmountChange(Number(e.target.value))} />
